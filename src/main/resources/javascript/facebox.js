...
//arie's changes
    ...
    //else 
	if (jQuery.isFunction(data)) data.call(jQuery)
  ...
  jQuery.extend(jQuery.facebox, {
    settings: {
      opacity      : 0,
      overlay      : true,
      loadingImage : '/download/resources/confluence-twitter%3Asocial-networking-resources/images/loading.gif',
      closeImage   : '/download/resources/confluence-twitter%3Asocial-networking-resources/images/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="/download/resources/confluence-twitter%3Asocial-networking-resources/images/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
...
//.click(function() { jQuery(document).trigger('close.facebox') })
  ...
  jQuery(document).bind('kampred.facebox', function(){
	//alert("si kampred");
  });
